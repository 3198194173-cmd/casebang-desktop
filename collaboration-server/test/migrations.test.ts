...
describe('database migration files', () => {
  it('are ordered, transaction-runner compatible, and contain the central ledger safeguards', async () => {
    ...
    expect(names).toEqual(['001_foundation.sql', '002_stream_events.sql', '003_dingtalk_auth.sql', '004_business_roles.sql', '005_weboffice.sql', '006_relaxed_workbook_participants.sql', '007_personal_artwork_sources.sql', '008_artwork_work_targets.sql'])
