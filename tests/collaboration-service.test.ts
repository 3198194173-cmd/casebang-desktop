...
describe('desktop collaboration service', () => {
  ...
  it('publishes an exported workbook without asking the user to choose a recipient', async () => {
    ...
    const workbook = Buffer.alloc(256 * 1024 + 11, 7)
    ...
    vi.mocked(net.fetch)
      .mockResolvedValueOnce(new Response(JSON.stringify({ uploadId: '40000000-0000-4000-8000-000000000001', chunkSize: 256 * 1024, totalChunks: 2 }), { status: 201 }))
